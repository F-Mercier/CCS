...
/**
 * <!-- begin-user-doc -->
 * An implementation of the model object '<em><b>RGamma2 DB</b></em>'.
 * <!-- end-user-doc -->
 * <p>
 * The following features are implemented:
 * </p>
 * <ul>
 *   <li>{@link cCS.impl.RGamma2DBImpl#getAgamma2db <em>Agamma2db</em>}</li>
 * </ul>
 *
 * @generated
 */
public class RGamma2DBImpl extends PRImpl implements RGamma2DB {
	/**
	...
	protected EClass eStaticClass() {
		return CCSPackage.Literals.RGAMMA2_DB;
	}
		...
		if (agamma2db != null && agamma2db.eIsProxy()) {
			...
			if (agamma2db != oldAgamma2db) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, CCSPackage.RGAMMA2_DB__AGAMMA2DB,
	...
	public void setAgamma2db(AGamma2DB newAgamma2db) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, CCSPackage.RGAMMA2_DB__AGAMMA2DB, oldAgamma2db,
					agamma2db));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
		case CCSPackage.RGAMMA2_DB__AGAMMA2DB:
			if (resolve)
				return getAgamma2db();
