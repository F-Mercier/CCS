...
/**
 * <!-- begin-user-doc -->
 * An implementation of the model object '<em><b>RDB2 Gamma</b></em>'.
 * <!-- end-user-doc -->
 * <p>
 * The following features are implemented:
 * </p>
 * <ul>
 *   <li>{@link cCS.impl.RDB2GammaImpl#getAdb2gamma <em>Adb2gamma</em>}</li>
 * </ul>
 *
 * @generated
 */
public class RDB2GammaImpl extends RRImpl implements RDB2Gamma {
	/**
	...
	protected EClass eStaticClass() {
		return CCSPackage.Literals.RDB2_GAMMA;
	}
		...
		if (adb2gamma != null && adb2gamma.eIsProxy()) {
			...
			if (adb2gamma != oldAdb2gamma) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, CCSPackage.RDB2_GAMMA__ADB2GAMMA,
	...
	public void setAdb2gamma(ADB2Gamma newAdb2gamma) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, CCSPackage.RDB2_GAMMA__ADB2GAMMA, oldAdb2gamma,
					adb2gamma));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
		case CCSPackage.RDB2_GAMMA__ADB2GAMMA:
			if (resolve)
				return getAdb2gamma();
