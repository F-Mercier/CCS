...
/**
 * <!-- begin-user-doc -->
 * An implementation of the model object '<em><b>RConnect2 Gamma</b></em>'.
 * <!-- end-user-doc -->
 * <p>
 * The following features are implemented:
 * </p>
 * <ul>
 *   <li>{@link cCS.impl.RConnect2GammaImpl#getAconnect2gamma <em>Aconnect2gamma</em>}</li>
 * </ul>
 *
 * @generated
 */
public class RConnect2GammaImpl extends RRImpl implements RConnect2Gamma {
	/**
	...
	protected EClass eStaticClass() {
		return CCSPackage.Literals.RCONNECT2_GAMMA;
	}
			...
			if (aconnect2gamma != oldAconnect2gamma) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE,
							CCSPackage.RCONNECT2_GAMMA__ACONNECT2GAMMA, oldAconnect2gamma, aconnect2gamma));
			}
		}
	...
	public void setAconnect2gamma(AConnect2Gamma newAconnect2gamma) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, CCSPackage.RCONNECT2_GAMMA__ACONNECT2GAMMA,
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
		case CCSPackage.RCONNECT2_GAMMA__ACONNECT2GAMMA:
			if (resolve)
