...
/**
 * <!-- begin-user-doc -->
 * An implementation of the model object '<em><b>Serv Conf2 Connect Serv P</b></em>'.
 * <!-- end-user-doc -->
 * <p>
 * The following features are implemented:
 * </p>
 * <ul>
 *   <li>{@link cCS.impl.ServConf2ConnectServPImpl#getServconf2connectbinding <em>Servconf2connectbinding</em>}</li>
 * </ul>
 *
 * @generated
 */
public class ServConf2ConnectServPImpl extends MinimalEObjectImpl.Container implements ServConf2ConnectServP {
	/**
	 ...
	 * @generated
	 */
	protected ServConf2ConnectServPImpl() {
		super();
	}
	...
	protected EClass eStaticClass() {
		return CCSPackage.Literals.SERV_CONF2_CONNECT_SERV_P;
	}
			...
			if (servconf2connectbinding != oldServconf2connectbinding) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE,
							CCSPackage.SERV_CONF2_CONNECT_SERV_P__SERVCONF2CONNECTBINDING, oldServconf2connectbinding,
		...
		if (newServconf2connectbinding != servconf2connectbinding) {
			...
			if (servconf2connectbinding != null)
				msgs = ((InternalEObject) servconf2connectbinding).eInverseRemove(this,
						CCSPackage.SERV_CONF2_CONNECT_BINDING__SERVCONF2CONNECTSERVP, ServConf2ConnectBinding.class,
						msgs);
			...
			eNotify(new ENotificationImpl(this, Notification.SET,
					CCSPackage.SERV_CONF2_CONNECT_SERV_P__SERVCONF2CONNECTBINDING, newServconf2connectbinding,
					newServconf2connectbinding));
	}
	...
	public NotificationChain eInverseAdd(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
		case CCSPackage.SERV_CONF2_CONNECT_SERV_P__SERVCONF2CONNECTBINDING:
			if (servconf2connectbinding != null)
				msgs = ((InternalEObject) servconf2connectbinding).eInverseRemove(this,
						CCSPackage.SERV_CONF2_CONNECT_BINDING__SERVCONF2CONNECTSERVP, ServConf2ConnectBinding.class,
						msgs);
