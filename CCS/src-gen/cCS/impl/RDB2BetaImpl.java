...
/**
 * <!-- begin-user-doc -->
 * An implementation of the model object '<em><b>RDB2 Beta</b></em>'.
 * <!-- end-user-doc -->
 * <p>
 * The following features are implemented:
 * </p>
 * <ul>
 *   <li>{@link cCS.impl.RDB2BetaImpl#getAdb2beta <em>Adb2beta</em>}</li>
 * </ul>
 *
 * @generated
 */
public class RDB2BetaImpl extends RRImpl implements RDB2Beta {
	/**
	...
	protected EClass eStaticClass() {
		return CCSPackage.Literals.RDB2_BETA;
	}
		...
		if (adb2beta != null && adb2beta.eIsProxy()) {
			...
			if (adb2beta != oldAdb2beta) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, CCSPackage.RDB2_BETA__ADB2BETA,
	...
	public void setAdb2beta(ADB2Beta newAdb2beta) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, CCSPackage.RDB2_BETA__ADB2BETA, oldAdb2beta,
					adb2beta));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
		case CCSPackage.RDB2_BETA__ADB2BETA:
			if (resolve)
				return getAdb2beta();
