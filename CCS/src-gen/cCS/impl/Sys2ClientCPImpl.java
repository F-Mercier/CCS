...
/**
 * <!-- begin-user-doc -->
 * An implementation of the model object '<em><b>Sys2 Client CP</b></em>'.
 * <!-- end-user-doc -->
 * <p>
 * The following features are implemented:
 * </p>
 * <ul>
 *   <li>{@link cCS.impl.Sys2ClientCPImpl#getSys2clientbinding <em>Sys2clientbinding</em>}</li>
 * </ul>
 *
 * @generated
 */
public class Sys2ClientCPImpl extends PPCompImpl implements Sys2ClientCP {
	/**
	...
	protected EClass eStaticClass() {
		return CCSPackage.Literals.SYS2_CLIENT_CP;
	}
			...
			if (sys2clientbinding != oldSys2clientbinding) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE,
							CCSPackage.SYS2_CLIENT_CP__SYS2CLIENTBINDING, oldSys2clientbinding, sys2clientbinding));
			}
		}
	...
	public NotificationChain basicSetSys2clientbinding(Sys2ClientBinding newSys2clientbinding, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET,
					CCSPackage.SYS2_CLIENT_CP__SYS2CLIENTBINDING, oldSys2clientbinding, newSys2clientbinding);
			if (msgs == null)
				msgs = notification;
			else
		...
		if (newSys2clientbinding != sys2clientbinding) {
			...
			if (sys2clientbinding != null)
				msgs = ((InternalEObject) sys2clientbinding).eInverseRemove(this,
						CCSPackage.SYS2_CLIENT_BINDING__SYS2CLIENTCP, Sys2ClientBinding.class, msgs);
			...
			eNotify(new ENotificationImpl(this, Notification.SET, CCSPackage.SYS2_CLIENT_CP__SYS2CLIENTBINDING,
	...
	public NotificationChain eInverseAdd(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
		case CCSPackage.SYS2_CLIENT_CP__SYS2CLIENTBINDING:
			if (sys2clientbinding != null)
				msgs = ((InternalEObject) sys2clientbinding).eInverseRemove(this,
						CCSPackage.SYS2_CLIENT_BINDING__SYS2CLIENTCP, Sys2ClientBinding.class, msgs);
