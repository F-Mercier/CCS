...
/**
 * <!-- begin-user-doc -->
 * An implementation of the model object '<em><b>PSec2 Alpha</b></em>'.
 * <!-- end-user-doc -->
 * <p>
 * The following features are implemented:
 * </p>
 * <ul>
 *   <li>{@link cCS.impl.PSec2AlphaImpl#getAsec2alpha <em>Asec2alpha</em>}</li>
 * </ul>
 *
 * @generated
 */
public class PSec2AlphaImpl extends PPCompImpl implements PSec2Alpha {
	/**
	...
	protected EClass eStaticClass() {
		return CCSPackage.Literals.PSEC2_ALPHA;
	}
		...
		if (asec2alpha != null && asec2alpha.eIsProxy()) {
			...
			if (asec2alpha != oldAsec2alpha) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, CCSPackage.PSEC2_ALPHA__ASEC2ALPHA,
	...
	public void setAsec2alpha(ASec2Alpha newAsec2alpha) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, CCSPackage.PSEC2_ALPHA__ASEC2ALPHA, oldAsec2alpha,
					asec2alpha));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
		case CCSPackage.PSEC2_ALPHA__ASEC2ALPHA:
			if (resolve)
