...
/**
 * <!-- begin-user-doc -->
 * An implementation of the model object '<em><b>RAlpha2 Connect</b></em>'.
 * <!-- end-user-doc -->
 * <p>
 * The following features are implemented:
 * </p>
 * <ul>
 *   <li>{@link cCS.impl.RAlpha2ConnectImpl#getAalpha2connect <em>Aalpha2connect</em>}</li>
 * </ul>
 *
 * @generated
 */
public class RAlpha2ConnectImpl extends PRImpl implements RAlpha2Connect {
	/**
	...
	protected EClass eStaticClass() {
		return CCSPackage.Literals.RALPHA2_CONNECT;
	}
			...
			if (aalpha2connect != oldAalpha2connect) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE,
							CCSPackage.RALPHA2_CONNECT__AALPHA2CONNECT, oldAalpha2connect, aalpha2connect));
			}
		}
	...
	public void setAalpha2connect(AAlpha2Connect newAalpha2connect) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, CCSPackage.RALPHA2_CONNECT__AALPHA2CONNECT,
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
		case CCSPackage.RALPHA2_CONNECT__AALPHA2CONNECT:
			if (resolve)
