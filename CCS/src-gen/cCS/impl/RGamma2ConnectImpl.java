...
/**
 * <!-- begin-user-doc -->
 * An implementation of the model object '<em><b>RGamma2 Connect</b></em>'.
 * <!-- end-user-doc -->
 * <p>
 * The following features are implemented:
 * </p>
 * <ul>
 *   <li>{@link cCS.impl.RGamma2ConnectImpl#getAgamma2connect <em>Agamma2connect</em>}</li>
 * </ul>
 *
 * @generated
 */
public class RGamma2ConnectImpl extends PRImpl implements RGamma2Connect {
	/**
	...
	protected EClass eStaticClass() {
		return CCSPackage.Literals.RGAMMA2_CONNECT;
	}
			...
			if (agamma2connect != oldAgamma2connect) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE,
							CCSPackage.RGAMMA2_CONNECT__AGAMMA2CONNECT, oldAgamma2connect, agamma2connect));
			}
		}
	...
	public void setAgamma2connect(AGamma2Connect newAgamma2connect) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, CCSPackage.RGAMMA2_CONNECT__AGAMMA2CONNECT,
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
		case CCSPackage.RGAMMA2_CONNECT__AGAMMA2CONNECT:
			if (resolve)
