...
/**
 * <!-- begin-user-doc -->
 * An implementation of the model object '<em><b>Serv Conf2 Serv Comp Comp P</b></em>'.
 * <!-- end-user-doc -->
 * <p>
 * The following features are implemented:
 * </p>
 * <ul>
 *   <li>{@link cCS.impl.ServConf2ServCompCompPImpl#getServ2servbinding <em>Serv2servbinding</em>}</li>
 * </ul>
 *
 * @generated
 */
public class ServConf2ServCompCompPImpl extends PPCompImpl implements ServConf2ServCompCompP {
	/**
	 ...
	 * @generated
	 */
	protected ServConf2ServCompCompPImpl() {
		super();
	}
	...
	protected EClass eStaticClass() {
		return CCSPackage.Literals.SERV_CONF2_SERV_COMP_COMP_P;
	}
			...
			if (serv2servbinding != oldServ2servbinding) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE,
							CCSPackage.SERV_CONF2_SERV_COMP_COMP_P__SERV2SERVBINDING, oldServ2servbinding,
							serv2servbinding));
			}
		}
	...
	public NotificationChain basicSetServ2servbinding(Serv2ServBinding newServ2servbinding, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET,
					CCSPackage.SERV_CONF2_SERV_COMP_COMP_P__SERV2SERVBINDING, oldServ2servbinding, newServ2servbinding);
			if (msgs == null)
				msgs = notification;
			else
		...
		if (newServ2servbinding != serv2servbinding) {
			...
			if (serv2servbinding != null)
				msgs = ((InternalEObject) serv2servbinding).eInverseRemove(this,
						CCSPackage.SERV2_SERV_BINDING__SERVCONF2SERVCOMPCOMPP, Serv2ServBinding.class, msgs);
			...
			eNotify(new ENotificationImpl(this, Notification.SET,
					CCSPackage.SERV_CONF2_SERV_COMP_COMP_P__SERV2SERVBINDING, newServ2servbinding,
					newServ2servbinding));
	}
	...
	public NotificationChain eInverseAdd(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
		case CCSPackage.SERV_CONF2_SERV_COMP_COMP_P__SERV2SERVBINDING:
			if (serv2servbinding != null)
				msgs = ((InternalEObject) serv2servbinding).eInverseRemove(this,
						CCSPackage.SERV2_SERV_BINDING__SERVCONF2SERVCOMPCOMPP, Serv2ServBinding.class, msgs);
